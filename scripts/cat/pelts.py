...
class Pelt():
    ...
    eye_colours = ['YELLOW', 'COPAL', 'HAZEL', 'PALE GREEN', 'GREEN', 'BLUE',
    ...
    red_eyes = ['COPAL', 'COPPER', 'HAZELNUT', 'DARK COPAL', 'RUBY', 'CHOCOLATE']
    ...
    colour_categories = [white_colours, blue_colours, gray_colours, black_colours, cream_colours, gold_colours,
                     ...
                     brown_colours]
    eye_sprites = [
        'YELLOW', 'COPAL', 'HAZEL', 'PALE GREEN', 'GREEN', 'BLUE', 'DARK BLUE', 'GREY', 'CYAN', 'EMERALD', 'HEATHER BLUE',
        'SUN-LIT ICE', 'COPPER', 'SAGE', 'BRIGHT BLUE', 'PALE BLUE', 'LAVENDER', 'DARK GREY', 'PALE YELLOW', 'GOLD', 'LIME',
        'HAZELNUT', 'DARK COPAL', 'SLATE', 'RUBY', 'LILAC', 'LIGHT GREY', 'PINK', 'DARK HAZEL', 'CHOCOLATE'
    ]
